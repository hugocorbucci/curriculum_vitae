...
\begin{tabular}{p{2.5cm}|p{13.5cm}}
  \emph{Atual} & \textsc{ThoughtWorks} - Consultor Sênior\\
...
\begin{tabular}{p{2.5cm}l}
  \textsc{Out 2011} & Palestrante no \textbf{Ágiles 2011}\\
  &Apresentando um workshop sobre ``Dívida Técnica'' em Buenos Aires, Argentina.\\
\end{tabular}

\begin{tabular}{p{2.5cm}l}
  \textsc{Jul 2011} & Palestrante no \textbf{Caipira Ágil 2011}\\
  &Apresentando um workshop sobre ``Lean Lego Game'' em Campinas, SP, Brazil.\\
\end{tabular}

\begin{tabular}{p{2.5cm}l}
  \textsc{Jun 2011} & Palestrante na \textbf{Agile Brazil 2011}\\
  &Dando uma palestrante chamada ``Protótipos são Eternos'' e\\
  &um Workshop chamado ``Coding Dojo - Formato Kake'' em Fortaleza, CE, Brazil.\\
\end{tabular}

\begin{tabular}{p{2.5cm}l}
  \textsc{Mai 2011} & Palestrante no \textbf{CONSEGI 2011}\\
  &Dando uma palestra chamada ``Open Source e Métodos Ágeis: Dois mundos mais próximos do que parece'' em Brasília, DF, Brazil.\\
\end{tabular}

\begin{tabular}{p{2.5cm}l}
  \textsc{Nov 2010} & Palestrante no \textbf{Encontro Ágil 2010}\\
...
\begin{tabular}{p{2.5cm}l}
  \textsc{Nov 2008} & Palestrante no \textbf{ESELAW 2008}\\
...
Ficção Científica, Escalada, Viajar, Vinhos, Teatro e Cinema.
